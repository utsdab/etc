...
#export PYTHONHOME="/Applications/Autodesk/maya2017/Maya.app/Contents/Frameworks/Python.framework/Versions/Current"
#export DYLD_LIBRARY_PATH="/Applications/Autodesk/maya2017/Maya.app/Contents/MacOS:${DYLD_LIBRARY_PATH}"
...
#export PYTHONPATH="/Applications/Pixar/Tractor-2.2/lib/python2.7/site-packages:${DABSWW}:${PYTHONPATH}"
#
